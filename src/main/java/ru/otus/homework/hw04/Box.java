...
public class Box {
    ...
    public void printBoxInfo() {
        System.out.println("Длина коробки: " + length + " Ширина коробки: " + width + " Высота коробки: " + height +
                " Цвет коробки: " + color + (isOpenBox ? ". Коробка открыта" : ". Коробка закрыта") +
                (this.item != null ? ". В коробке лежит " + this.item : ". В коробке нет предмета") + "\n");
    }
    ...
    public void putItem(String item) {
        if (isOpenBox && this.item == null) {
            ...
            System.out.println(isOpenBox ? "В коробку нельзя положить новый предмет " + item + ".В коробке уже лежит предмет - " +
                    this.item : "В коробку нельзя положить предмет " + item + ", коробка закрыта ");
        }
    }
